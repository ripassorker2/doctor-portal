...
const Contact = () => {
  return (
    <div>
      ...
      >
        <div className="container my-16 pt-7 px-6 mx-auto">
          <section className="mb-32 text-gray-800">
            ...
            "
                      ...
                      <button
                        type="submit"
                        className="
                      inline-block w-full rounded bg-secondary px-12 py-3 text-sm font-medium text-white shadow  focus:outline-none focus:ring active:bg-rose-500  "
                      >
                        Send
                      </button>
                    </form>
                      ...
                      <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                        <div className="flex items-start">
                          <div className="shrink-0">
                            <div className="p-4 bg-secondary rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                              <svg
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fas"
                          ...
                          <div className="grow ml-6">
                            ...
                            <p className="text-gray-200">+1 234-567-89</p>
                          </div>
                        </div>
                      </div>
                      <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      ...
                      <div className="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                        <div className="flex align-start">
                          ...
                          <div className="grow ml-6">
                            ...
                            <p className="text-gray-200">press@example.com</p>
                            <p className="text-gray-200">+1 234-567-89</p>
                          </div>
                        </div>
                      </div>
                      <div className="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                        <div className="flex align-start">
                          ...
                          <div className="grow ml-6">
                            ...
                            <p className="text-gray-200">bugs@example.com</p>
                            <p className="text-gray-200">+1 234-567-89</p>
                          </div>
                        </div>
                      </div>
